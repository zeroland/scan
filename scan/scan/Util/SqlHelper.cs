...
namespace scan.Util
{
    ...
    public  class SqlHelper
    {
        ...
        /// </summary>
        /// <returns></returns>
        public static SqlTransaction GetSqlTranscation(SqlConnection sqlConnection)
        {
            SqlTransaction sqlTranscation = sqlConnection.BeginTransaction();
            return sqlTranscation;
        }
